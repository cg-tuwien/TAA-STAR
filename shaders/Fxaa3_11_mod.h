// ac mod: renamed double underscore defines to avoid glslang warnings
//          FXAA_QUALITY__PRESET    -> FXAA_QUALITY_PRESET 
//          FXAA_QUALITY__P*        -> FXAA_QUALITY_P*
//          FXAA_CONSOLE__PS*       -> FXAA_CONSOLE_PS*
